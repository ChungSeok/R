...
##-------객체 생성---------
help(read.delim)
spiderLong<-read.delim(file="dat/SpiderLong.dat", header = TRUE)
spiderWide<-read.delim(file="dat/SpiderWide.dat", header = TRUE)
...
summary(t.test.GLM)
#GLM(general linear model): 일반화 선형 모형
#lm()함수: 회귀분석, 단일 계층 분석, 공분산 분석에 이용할 수 있음
