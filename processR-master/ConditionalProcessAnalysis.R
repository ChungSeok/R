...
# I. PROCESS Macro for R 활용 -----------------------------------------------
# 1.  필요한 파일 다운로드 및 PROCESS 활성화 방법 ---------------------------------------------------------
# http://processmacro.org/download.html => Download PROCESS v4.0 클릭 => 압축파일 해제 => processv40 폴더 => PROCESS v4.0 for R 폴더 => process.R 파일을 Rstudio 파일에서 열기 => 전체 코드실행 (수 분 소요) => PROCESS 가동됨 (SPSS에서 syntax를 사용할 때 PROCESS.sps 파일을 여는것과 유사한 개념)
...
# 2. 실습사례 : 팀에서 감정을 숨기기 ---------------------------------------------------
# Cole et al.(2008)은 자동차 부품회사의 60개 팀을 대상으로 4가지 변수 측정 | 직장, 특히 팀 내에서 업무를 함께할 경우에는 자신의 감정을 억누르는 것이 팀의 업무효율을 위해 긍정적인 효과를 나타내는가?
...
# 데이터구조파악 => 4개 변수, 60개 관측치
str(teams)

# 3. PROCESS Syntax 입력, 실행 ------------------------------------------------
